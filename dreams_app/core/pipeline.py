...
from dreams_app.core.sentiment import get_sentiment
from dreams_app.core.embeddings import get_text_embedding, get_image_embedding
...
class DreamsPipeline:
    ...
    def generate_narrative_metrics(self, user_id: str, user_posts: List[Dict]) -> Dict[str, Any]:
        ...
        from dreams_app.core.graph.temporal_narrative_graph import build_narrative_graph
    ...
    def ingest_csv(self, csv_path: str) -> None:
        ...
        from dreams_app.core.database import db_manager
